...
ZombieConductor.prototype.mover = function() {
    ...
    if (((this.x < this.rangoMov.desdeX - this.ancho) || (this.x > this.rangoMov.hastaX - this.ancho)) && this.direccion == "h") {
        this.velocidad *= -1;
    }
    // Si sobrepasa el rangoY, lo manda al centro entre ambos rangos
    if (((this.y < this.rangoMov.desdeY - this.alto) || (this.y > this.rangoMov.hastaY - this.alto)) && this.direccion == "v") {
        this.velocidad *= -1;
    }
}